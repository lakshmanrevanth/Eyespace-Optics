  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 space-y-8">
      <div className="text-center space-y-4">
        <h1 className="text-2xl md:text-3xl font-medium text-[#7A6F5C]">
          SPECTACLE AND PRESCRIPTION SUNGLASS LENSES
        </h1>
        <h2 className="text-xl md:text-2xl text-[#7A6F5C]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {lensTypes.map((lens, index) => (
          <Card key={index}>
            ...
            <h3 className="text-xl font-medium text-[#7A6F5C] mb-4">
              {lens.title}
            </h3>
            <p className="text-[#7A6F5C] text-sm leading-relaxed">
              {lens.description}
            </p>
          </Card>
        ))}
