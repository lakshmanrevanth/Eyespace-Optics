  ...
  return (
    <div className="relative  overflow-hidden w-full">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              <h1 className="text-4xl tracking-tight font-extrabold text-[#7A6F5C] sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Special Contact Lenses</span>
              </h1>
              ...
              <p className="mt-6 text-[#555555] leading-relaxed text-lg sm:mt-5 sm:text-base sm:mx-auto md:mt-5 md:text-lg lg:mx-0">
                We are authorized retailers for all brands of spectacles,
                sunglasses, and contact lenses. We dispense only tried and
                tested products from world-class lens manufacturers like
                Essilor, Carl Zeiss, Nikon, Bausch & Lomb, Johnson & Johnson,
                Cooper Vision, and more.
              </p>
              <p className="mt-4 text-[#555555] leading-relaxed text-lg sm:text-base sm:max-w-xl sm:mx-auto md:text-lg lg:mx-0">
                As a testimony to our expertise in dispensing optics, we were
                nominated as the first Essilor Expert in South India and were
                awarded by Times Healthcare for Service Excellence in Opticianry
                and Optometry.
              </p>
            </div>
          </main>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 w-full">
        <img
          src="/assets/images/products/special_contact_lenses_hero.png"
