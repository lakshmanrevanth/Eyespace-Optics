...
export default function EyeOpticalInfo() {
  return (
    <div className="min-h-screen text-[#967c5b] w-[95%] mx-auto scroll-smooth bg-[#F7F3EF]">
      {/* Hero Section */}
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-12 bg-white">
        <div className="text-center space-y-6">
          <h2 className="text-3xl md:text-4xl font-semibold text-[#967c5b]">
            Types of Lenses
          </h2>
        </div>
        <LensesTypeComponent />
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-12 bg-white">
        <div className="text-center space-y-6">
          <h2 className="text-3xl md:text-4xl font-semibold text-[#967c5b] mb-4">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-12 bg-white">
        <div className="text-center space-y-6">
          ...
          <p className="text-lg text-[#4A4A4A] leading-relaxed">
            ...
            clear and photochromic lenses will be available in almost all
            materials.
          </p>
          <p className="text-lg italic text-[#4A4A4A]">
            To know which lens is best suited for your needs, please consult our
