            ...
            {[
              {
                icon: Sun,
                title: "UV Protection",
                description: "100% UV protection to keep your eyes safe",
              },
              {
                icon: Shield,
                title: "Scratch Resistant",
                description: "Durable lenses that withstand daily wear",
              },
              {
                icon: Zap,
                title: "Quick & Easy",
                description: "Attach and remove in seconds",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
            ...
            {[
              {
                ...
                description: "Select from our wide range of clip-on designs",
              },
              {
                step: 2,
                title: "Clip Them On",
                description:
                  "Easily attach the clip-ons to your existing glasses",
              },
              {
                step: 3,
                title: "Enjoy the View",
                description: "Experience instant sun protection and style",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
            ...
            {[
              {
                name: "Alex M.",
                quote:
                  "These clip-ons are a game-changer! So convenient and stylish.",
              },
              {
                name: "Sarah L.",
                quote:
                  "I love how quickly I can switch between indoor and outdoor wear.",
              },
              {
                name: "Chris P.",
                quote:
                  "The quality is outstanding. Best clip-ons I've ever used!",
              },
      ...
      <section className="py-16 px-4 bg-[#9d8189]">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl mb-8">
            Experience the convenience and style of our clip-on sunglasses
            today!
          </p>
          <motion.button
